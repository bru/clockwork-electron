(defproject clockwork-electron "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds {:dev-main {:source-paths ["src"]
                                  ...
                                  :compiler {:output-to "app/dev/js/cljsbuild-main.js"
                                             ...
                                             :pretty-print true
                                             :output-wrapper true}}
                       :dev-front {:source-paths ["src_front" "src_front_profile/clockwork_electron_front/dev"]
                                   :incremental true
                                   :jar true
                                   :assert true
                       ...
                       :prod-main {:source-paths ["src"]
                                   ...
                                   :compiler {:output-to "app/prod/js/cljsbuild-main.js"
                                              ...
                                              :pretty-print true
                                              :output-wrapper true}}
                       :prod-front {:source-paths ["src_front" "src_front_profile/clockwork_electron_front/prod"]
                                    :incremental true
                                    :jar true
                                    :assert true
